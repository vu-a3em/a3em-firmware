...
int main(void)
{
   ...
   setup_hardware();
   audio_analog_init(AUDIO_NUM_CHANNELS, AUDIO_DEFAULT_SAMPLING_RATE_HZ, AUDIO_GAIN_DB, AUDIO_MIC_BIAS_VOLTAGE, COMPARATOR_THRESHOLD, AUDIO_TRIGGER_THRESHOLD_PERCENT, &device_activated);
