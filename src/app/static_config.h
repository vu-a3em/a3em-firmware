...
#define SELF_TEST_LEVEL_UPDATE_MS                   250
#define SELF_TEST_LEVEL_HOLD_MS                     400
#define SELF_TEST_AUDIO_BUFFER_SAMPLES              ((SELF_TEST_AUDIO_SAMPLE_RATE_HZ * SELF_TEST_LEVEL_UPDATE_MS) / 1000)
