...
typedef void (*imu_data_ready_callback_t)(float accel_x_mg, float accel_y_mg, float accel_z_mg);
...
float lis2du12_from_fs2g_to_mg(int16_t lsb);
float lis2du12_from_fs4g_to_mg(int16_t lsb);
float lis2du12_from_fs8g_to_mg(int16_t lsb);
float lis2du12_from_fs16g_to_mg(int16_t lsb);
float lis2du12_from_lsb_to_celsius(int16_t lsb);
...
int32_t lis2du12_interrupt_mode_get(const stmdev_ctx_t *ctx, lis2du12_int_mode_t *val);
...
int32_t lis2du12_orientation_mode_get(const stmdev_ctx_t *ctx, lis2du12_orient_md_t *val);
